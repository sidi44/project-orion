...
//		Gdx.input.setInputProcessor(inputProc);
	...
	private void defineAnimations() {
		...
		def9.setFilename("assets/predator2.png");
		def9.setColumns(1);
		def9.setRows(1);
		...
		def10.setFilename("assets/predator2.png");
		def10.setColumns(1);
		def10.setRows(1);
		def10.setStartFrame(1);
		def10.setEndFrame(7);
		...
		def11.setFilename("assets/predator2.png");
		def11.setColumns(1);
		def11.setRows(2);
		def11.setStartFrame(1);
		def11.setEndFrame(1);
		...
		def12.setFilename("assets/predator2.png");
		def12.setColumns(1);
		def12.setRows(2);
		def12.setStartFrame(1);
		def12.setEndFrame(7);
		...
		def13.setFilename("assets/predator2.png");
		def13.setColumns(1);
		def13.setRows(3);
		def13.setStartFrame(1);
		def13.setEndFrame(1);
		...
		def14.setFilename("assets/predator2.png");
		def14.setColumns(1);
		def14.setRows(3);
		def14.setStartFrame(1);
		def14.setEndFrame(7);
		...
		def15.setFilename("assets/predator2.png");
		def15.setColumns(1);
		def15.setRows(4);
		def15.setStartFrame(1);
		def15.setEndFrame(1);
		...
		def16.setFilename("assets/predator2.png");
		def16.setColumns(1);
		def16.setRows(4);
		def16.setStartFrame(1);
		def16.setEndFrame(7);
